...
-- renderSVGDrawing (RenderingOptions {dimensions, originPlacement}) drawing = drawingToRenderedSVGThing' mempty $ placeOrigo $ scaleXY (V2 0 (-1)) $ drawing
--   where
