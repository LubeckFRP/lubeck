...
var nElems  = 500
var nMaxFrames = 60*100
// GHC test: with 0x1000000 we run for a long time, with 0x100000 we go blank in a second
var nHeapSize = 0x100000
...
/*
  ...
  32-byte regions stored at values > 0x1000.
  ...
  the slot see the corresponding constructor function (i.e. search for 1 to
...
// This region stores the tuples. Its size is (heap size - 0x1000).
...
function createRenderer(c2) {
  ...
  var colorBuffer = new Uint8Array(heap, 0, 22);
  ...
  res.ap = function(xs) {
    ...
    var empty = res.primRect(0,0,0,0)
    return xs.reduce(function (a,b) {
      return res.primAp2(b,a) // Reverse order
    }, empty)
  }
  res.empty = function () {
    return res.ap([])
...
//         r.randCol(r.scale(1,r.randPosRect()))
//       ))
