...
Test a single image
-}
data LegacyDrawingTest = LegacyDrawingTest
  { ldt_name      :: !String
  , ldt_comment   :: !String
...
testBatchToMap :: [LegacyDrawingTest] -> Maybe (Map String String)
...
renderLegacyDrawingTestsToDir :: TestSuiteName -> FilePath -> [LegacyDrawingTest] -> IO ()
renderLegacyDrawingTestsToDir suiteName dir tests = do
  putStrLn $ msg suiteName dir
  renderLegacyDrawingTestsToDir1 dir tests
  where
    msg a b = "Rendering image test suite '" <> a <> "' to to directory '" <> b <> "'"

renderLegacyDrawingTestsToDir1 :: FilePath -> [LegacyDrawingTest] -> IO ()
renderLegacyDrawingTestsToDir1 dir tests = case testBatchToMap tests of
  Nothing -> error "renderLegacyDrawingTestsToFile: Duplicate names"
...
updateHashesDTs :: TestSuiteName -> FilePath -> [LegacyDrawingTest] -> IO ()
...
compareHashesDTs :: TestSuiteName -> FilePath -> [LegacyDrawingTest] -> IO Bool
...
test = LegacyDrawingTest "test1" "" $ unpackStr
...
test2 = LegacyDrawingTest "test2" "" $ unpackStr
  $ visualizeTest ([(1,2), (3,4)] :: [(Int, Int)]) line
  [ mempty
  , x <~ _1
  , y <~ to snd
  ]
test3 = LegacyDrawingTest "test3" "" $ unpackStr
...
test4 = LegacyDrawingTest "test4" "" $ unpackStr
...
test5 = LegacyDrawingTest "test5" "" $ unpackStr
  $ visualizeTest [(Mon, 100 :: Int), (Sun, 400)] line [x <~ to fst, y <~ to snd]


test6 = LegacyDrawingTest "test6" "" $ unpackStr
...
test7 = LegacyDrawingTest "test7" "" $ unpackStr
...
-- FIXME not working
test8a = LegacyDrawingTest "test8a" "" $ unpackStr
...
test8b = LegacyDrawingTest "test8b" "" $ unpackStr
...
test8c = LegacyDrawingTest "test8c" "" $ unpackStr
...
-- Cross-lines
test9 = LegacyDrawingTest "test9" "" $ unpackStr
...
test10 = LegacyDrawingTest "test10" "" $ unpackStr
...
-- Custom image.
test11 = LegacyDrawingTest "test11" "" $ unpackStr
  $ visualizeTest dat (mconcat [labelG, pointG, imageG])
  [ x <~ _1 `withScale` categorical
  , y <~ _2 `withScale` linearIntegral
  , contramap (const customDr) image <~ _2
...
test12 = LegacyDrawingTest "test12" "" $ unpackStr
  $ visualizeTest dat (mconcat [labelG, pointG, imageG])
  [ x <~ _1 `withScale` categorical
  , y <~ _2 `withScale` linearIntegral
  , size <~ _1
...
test13 = LegacyDrawingTest "test13" "" $ unpackStr
  $ visualizeTest dat (mconcat [labelG, pointG, imageG])
  [ x <~ _1 `withScale` categorical
  , y <~ _2 `withScale` linearIntegral
...
-- Custom image with size (linearly transformed).
test14 = LegacyDrawingTest "test14" "" $ unpackStr
  $ visualizeTest dat (mconcat [labelG, pointG, imageG])
  [ x <~ _1 `withScale` categorical
  , y <~ _2 `withScale` linearIntegral
  , contramap (\x -> -1*x + 1) size <~ _1
...
test20 = LegacyDrawingTest "test20" "" $ unpackStr
...
{-
  Same type/scale.
-}
test21 = LegacyDrawingTest "test21" "" $ unpackStr
  $ drawingToSvgString mempty mempty $ drawPlot $
  plot (zip
    ([1..10] :: [Int])
...
{-
  Different Y scales
-}
test22 = LegacyDrawingTest "test22" "" $ unpackStr
  $ drawingToSvgString mempty mempty $ drawPlot $
  plot (zip
    ([1..10] :: [Int])
...
{-
  Different X scales
-}
test23 = LegacyDrawingTest "test23" "" $ unpackStr
  $ drawingToSvgString mempty mempty $ drawPlot $
  plot (zip
    ([1..10] :: [Int])
    ([0,1,5,5,4,3,4,4,4,3] :: [Int])
...
{-
  Same type/scale.
-}
test24 = LegacyDrawingTest "test24" "" $ unpackStr
...
{-
  Bar plot.
-}
test25 = LegacyDrawingTest "test25" "" $ unpackStr
  $ drawingToSvgString mempty mempty $ drawPlot $
...
{-
  Bar plot (horizontal).
-}
test26 = LegacyDrawingTest "test26" "" $ unpackStr
...
-}
test27 = LegacyDrawingTest "test27" "" $ unpackStr
...
Bar plot with highlights (horizontal):
  ...
  - 3rd and 5th element selected
-}
test28 = LegacyDrawingTest "test28" "" $ unpackStr
...
{-
  Pie/circular plot.
-}
test29a = LegacyDrawingTest "test29a" "" $ unpackStr
...
{-
  Pie/circular plot.
-}
test29b = LegacyDrawingTest "test29b" "" $ unpackStr
  $ drawingToSvgString mempty (noXY .~ Any True $ mempty) $ drawPlot $
...
test30 = LegacyDrawingTest "test30" "" $ unpackStr
  $ drawingToSvgString
...
test31 = LegacyDrawingTest "test31" "" $ unpackStr
  $ drawingToSvgString
  -- (mempty { dimensions = P (V2 800 500), originPlacement = BottomLeft })
  -- (renderingRectangle .~ V2 800 500 $ mempty)
  mempty
...
test32 = LegacyDrawingTest "test32" "" $ unpackStr
  $ drawingToSvgString
  -- (mempty { dimensions = P (V2 800 500), originPlacement = BottomLeft })
  -- (renderingRectangle .~ V2 800 500 $ mempty)
  mempty
...
-- TODO
test33 = LegacyDrawingTest "test33" "" $ unpackStr
  $ drawingToSvgString
  -- (mempty { dimensions = P (V2 800 500), originPlacement = BottomLeft })
  -- (renderingRectangle .~ V2 800 500 $ mempty)
  mempty
...
-}
test35 = LegacyDrawingTest "test35" "" $ unpackStr
...
drawingPlusDvTestBatch = (drawingTestToLegacyDrawingTest <$> Std.drawingTestBatch) <> dvTestBatch

drawingTestToLegacyDrawingTest :: Std.DrawingTest SVG -> LegacyDrawingTest
drawingTestToLegacyDrawingTest (Std.DrawingTest n d dr) = LegacyDrawingTest n d (svgDraftToString dr)
  where
...
main' args = do
  case args of
    ...
    ["--report"] -> do
      renderLegacyDrawingTestsToDir "Drawing+DV tests" "/tmp/lubeck/dv/test/report" drawingPlusDvTestBatch
...
test :: LegacyDrawingTest
test2 :: LegacyDrawingTest
test3 :: LegacyDrawingTest
test4 :: LegacyDrawingTest
test5 :: LegacyDrawingTest
test6 :: LegacyDrawingTest
test7 :: LegacyDrawingTest
test8a :: LegacyDrawingTest
test8b :: LegacyDrawingTest
test8c :: LegacyDrawingTest
test9 :: LegacyDrawingTest
test10 :: LegacyDrawingTest
test11 :: LegacyDrawingTest
test12 :: LegacyDrawingTest
test13 :: LegacyDrawingTest
test14 :: LegacyDrawingTest
test20 :: LegacyDrawingTest
test21 :: LegacyDrawingTest
test22 :: LegacyDrawingTest
test23 :: LegacyDrawingTest
test24 :: LegacyDrawingTest
test25 :: LegacyDrawingTest
test26 :: LegacyDrawingTest
test30 :: LegacyDrawingTest
test31 :: LegacyDrawingTest
test32 :: LegacyDrawingTest
test33 :: LegacyDrawingTest
